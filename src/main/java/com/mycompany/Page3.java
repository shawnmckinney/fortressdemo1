...
public class Page3 extends MyBasePage
{
    ...
    public class Page3Form extends Form
    {
        ...
        public Page3Form( String id )
        {
            ...
            add( new SecureIndicatingAjaxButton( this, szBtn1, PAGE3, GlobalUtils.BUTTON1 )
            {
                @Override
            ...
            final String szBtn2 = GlobalUtils.BTN_PAGE_3 + "." + GlobalUtils.BUTTON2;
            add( new SecureIndicatingAjaxButton( this, szBtn2, PAGE3, GlobalUtils.BUTTON2 )
            {
                @Override
                protected void onSubmit( AjaxRequestTarget target, Form form )
                {
            ...
            final String szBtn3 = GlobalUtils.BTN_PAGE_3 + "." + GlobalUtils.BUTTON3;
            add( new SecureIndicatingAjaxButton( this, szBtn3, PAGE3, GlobalUtils.BUTTON3 )
            {
                @Override
                protected void onSubmit( AjaxRequestTarget target, Form form )
                {
