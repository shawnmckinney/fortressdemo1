 ...
 */
public class FortressDemo1SeleniumITCase
{
    private WebDriver driver;
    private String baseUrl;
    private boolean acceptNextAlert = true;
    private StringBuffer verificationErrors = new StringBuffer();
    private static final Logger LOG = Logger.getLogger( FortressDemo1SeleniumITCase.class.getName() );
    ...
    {
        LOG.info( "Begin FortressDemo1SeleniumITCase" );
        driver.get( baseUrl + "/fortressdemo1" );
